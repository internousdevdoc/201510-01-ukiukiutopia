package internousdev.Torken.Twitter;
...
public class TwitterRequestToken {
	...
	* コンシューマーキー
	*/
	final String CONSUMER_KEY = "5c0oldFxN9RYBiIeJYOfv8vuF";

	/**
	* コンシューマーシークレット
	*/
	final String CONSUMER_SECRET = "vZqXvNOutQWtyYOeLOGzkKjEVpmqPhX3mTyLVNUIYktGUkI9kt";
