...
import internousdev.Torken.Twitter.TwitterRequestToken;
...
public class GoTwitterAction extends ActionSupport implements ServletResponseAware,ServletRequestAware{
	...
	*/
	public String execute(){
		internousdev.Torken.Twitter.TwitterRequestToken a = new internousdev.Torken.Twitter.TwitterRequestToken();
		try {
